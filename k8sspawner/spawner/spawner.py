...
class Customk8sSpawner(KubeSpawner):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.logger = setup_logger(__name__, logging.ERROR)
        self.logger.info('Start working with Customk8sSpawner')
    ...
    def options_from_form(self, formdata):
        ...
        # ------------------------------------------------
        image_tag = formdata.get('jupyter_image', [''])[0].strip()
        self.image = select_image_from_input(image_tag)
